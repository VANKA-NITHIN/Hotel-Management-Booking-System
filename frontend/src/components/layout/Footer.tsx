        ...
        <div className="container-section py-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <form onSubmit={handleSubscribe} className="w-full md:w-auto flex gap-2 max-w-md">
            <input
              ...
              className="flex-1 min-w-[240px] px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-sm text-white placeholder-neutral-500 focus:outline-none focus:border-secondary transition-colors"
              required
            />
            <Button
              type="submit"
