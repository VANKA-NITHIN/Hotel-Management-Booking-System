    ...
    <div className="min-h-screen pt-24 pb-16 bg-bg-surface-hover">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-bg-surface rounded-2xl p-8 sm:p-12 shadow-sm border border-border-base">
          <h1 className="text-3xl font-serif font-bold text-text-base mb-8">Privacy Policy</h1>

          <div className="space-y-6 text-text-muted leading-relaxed">
            <p className="text-sm text-text-muted mb-8">Last Updated: October 2024</p>

            <section>
              <h2 className="text-xl font-bold text-text-base mt-8 mb-4">1. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-text-base mt-8 mb-4">2. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-text-base mt-8 mb-4">3. Data Sharing and Security</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-text-base mt-8 mb-4">4. Your Rights</h2>
